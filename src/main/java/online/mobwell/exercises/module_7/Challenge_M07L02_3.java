 ...
 * 
 * */
public class Challenge_M07L02_3 extends Exercise{
	double[] current_criteria = {0,0};
	double[] correct_criteria = {5,15};
	String code;
	
	
	public Challenge_M07L02_3(String name, String userId, ArrayList<TraineeCode> files) {
		super(name, userId, files);
		code = files.get(0).getCode();
	}
	
	public Challenge_M07L02_3() {
		super();
	}
